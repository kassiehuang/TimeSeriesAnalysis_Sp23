...
#group_by function is a preparation step for the summarize function here
...
ARIMA_Four_fit <- auto.arima(ts_act_power_daily_train, 
                             seasonal=FALSE, 
                             lambda=0,
                             #it's transforming the data to be normal distribution
...
#python is a lot more better on doing model with Neural Network
