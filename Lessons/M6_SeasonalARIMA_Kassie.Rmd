...
#**question: why don't we just use the seasadj() in the first place but to use this after the decompose function first?
...
#** question: I think my question links to my other question before about d&D: can we do in a reversed order to difference the seasonal first and then trend?
...
#because we've differenced twice, so we won't be allowing drift

#** question: correct me if I'm wrong: only allowing drift when d=1?
print(SARIMA_manual)
