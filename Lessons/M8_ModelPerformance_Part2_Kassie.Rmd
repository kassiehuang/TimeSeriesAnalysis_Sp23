...
manual_scores <- as.data.frame(cbind(ME,RMSE,MAE,MPE,MAPE))

#Exercise 2: Compute the forecast accuracy metrics you calculated in Ex 1 with the results from accuracy() function.
auto_scores <- as.data.frame(accuracy(object = forecast,x = actual))
...
#Kassie: the seperate() function works the same as "text to column" function
