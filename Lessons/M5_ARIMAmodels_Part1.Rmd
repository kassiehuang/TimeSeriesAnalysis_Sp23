...
#Notes:
#Only works for decomposed objects
#we're not using seasonal ARIMA yet so we need to deseason first
...
#Coefficients:
#         ar1      ma1   drift
#   phi=  0.2304  theta= -0.3706  0.0283
...
ACF&PACF residues: all within the bar will be the best
AIC values: lowest will be the best
...
*questions*
what can be some reasons for violation of seasonal means model's hypothesis? 
