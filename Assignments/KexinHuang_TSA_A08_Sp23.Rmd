...
The SARIMA model performs better forecast than using manually de-seasoning and fitting a non-seasonal ARIMA: the forecast from SARIMA is always closer to the actual seasonal data than the other one.
